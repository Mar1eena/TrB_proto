...
// 	protoc        v6.30.2
// source: services/server-grpc-receiving/proto/server.proto

package server_grpc_receiving
...
func (x *MessageRequest) Reset() {
	*x = MessageRequest{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[0]
...
func (*MessageRequest) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{0}
}
...
func (x *MessageResponse) Reset() {
	*x = MessageResponse{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MessageResponse) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{1}
}
...
func (x *PoliceRequest) Reset() {
	*x = PoliceRequest{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PoliceRequest) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{2}
}
...
func (x *PoliceResponse) Reset() {
	*x = PoliceResponse{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PoliceResponse) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{3}
}
...
func (x *PoliceStreamResponse) Reset() {
	*x = PoliceStreamResponse{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PoliceStreamResponse) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{4}
}
...
func (x *ClientStreamRequest) Reset() {
	*x = ClientStreamRequest{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientStreamRequest) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{5}
}
...
func (x *StreamSummary) Reset() {
	*x = StreamSummary{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamSummary) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{6}
}
...
func (x *BidirectionalMessage) Reset() {
	*x = BidirectionalMessage{}
	mi := &file_services_server_grpc_receiving_proto_server_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BidirectionalMessage) Descriptor() ([]byte, []int) {
	return file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP(), []int{7}
}
...
var File_services_server_grpc_receiving_proto_server_proto protoreflect.FileDescriptor

const file_services_server_grpc_receiving_proto_server_proto_rawDesc = "" +
	"\n" +
	"1services/server-grpc-receiving/proto/server.proto\x12\x06server\x1a\x1cgoogle/api/annotations.proto\"$\n" +
	...
	"\x13BidirectionalStream\x12\x1c.server.BidirectionalMessage\x1a\x1c.server.BidirectionalMessage(\x010\x01B>Z<github.com/Mar1eena/trb_proto/services/server-grpc-receivingb\x06proto3"

var (
	file_services_server_grpc_receiving_proto_server_proto_rawDescOnce sync.Once
	file_services_server_grpc_receiving_proto_server_proto_rawDescData []byte
)

func file_services_server_grpc_receiving_proto_server_proto_rawDescGZIP() []byte {
	file_services_server_grpc_receiving_proto_server_proto_rawDescOnce.Do(func() {
		file_services_server_grpc_receiving_proto_server_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_server_grpc_receiving_proto_server_proto_rawDesc), len(file_services_server_grpc_receiving_proto_server_proto_rawDesc)))
	})
	return file_services_server_grpc_receiving_proto_server_proto_rawDescData
}

var file_services_server_grpc_receiving_proto_server_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_services_server_grpc_receiving_proto_server_proto_goTypes = []any{
...
var file_services_server_grpc_receiving_proto_server_proto_depIdxs = []int32{
...
func init() { file_services_server_grpc_receiving_proto_server_proto_init() }
func file_services_server_grpc_receiving_proto_server_proto_init() {
	if File_services_server_grpc_receiving_proto_server_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_services_server_grpc_receiving_proto_server_proto_rawDesc), len(file_services_server_grpc_receiving_proto_server_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_server_grpc_receiving_proto_server_proto_goTypes,
		DependencyIndexes: file_services_server_grpc_receiving_proto_server_proto_depIdxs,
		MessageInfos:      file_services_server_grpc_receiving_proto_server_proto_msgTypes,
	}.Build()
	File_services_server_grpc_receiving_proto_server_proto = out.File
	file_services_server_grpc_receiving_proto_server_proto_goTypes = nil
	file_services_server_grpc_receiving_proto_server_proto_depIdxs = nil
}
