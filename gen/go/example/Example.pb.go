...
const file_example_Example_proto_rawDesc = "" +
	"\n" +
	"\x15example/Example.proto\x12\x13example.contract.v1\x1a\x1cgoogle/api/annotations.proto\"$\n" +
	...
	"\x04text\x18\x01 \x01(\tR\x04text2\xce\x03\n" +
	"\aexample\x12o\n" +
	"\x0fUnaryRPCMessage\x12#.example.contract.v1.MessageRequest\x1a$.example.contract.v1.MessageResponse\"\x11\x82\xd3\xe4\x93\x02\v:\x01*\"\x06/unary\x12y\n" +
	"\x10ServerSideStream\x12#.example.contract.v1.MessageRequest\x1a*.example.contract.v1.MessageStreamResponse\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\a/stream0\x01\x12e\n" +
	"\x10ClientSideStream\x12).example.contract.v1.MessageStreamRequest\x1a$.example.contract.v1.MessageResponse(\x01\x12p\n" +
	"\x13BidirectionalStream\x12).example.contract.v1.MessageStreamRequest\x1a*.example.contract.v1.MessageStreamResponse(\x010\x01B<Z:github.com/Mar1eena/trb_proto/services/example.contract.v1b\x06proto3"
...
var file_example_Example_proto_goTypes = []any{
	(*MessageRequest)(nil),        // 0: example.contract.v1.MessageRequest
	(*MessageResponse)(nil),       // 1: example.contract.v1.MessageResponse
	(*MessageStreamRequest)(nil),  // 2: example.contract.v1.MessageStreamRequest
	(*MessageStreamResponse)(nil), // 3: example.contract.v1.MessageStreamResponse
}
var file_example_Example_proto_depIdxs = []int32{
	0, // 0: example.contract.v1.example.UnaryRPCMessage:input_type -> example.contract.v1.MessageRequest
	0, // 1: example.contract.v1.example.ServerSideStream:input_type -> example.contract.v1.MessageRequest
	2, // 2: example.contract.v1.example.ClientSideStream:input_type -> example.contract.v1.MessageStreamRequest
	2, // 3: example.contract.v1.example.BidirectionalStream:input_type -> example.contract.v1.MessageStreamRequest
	1, // 4: example.contract.v1.example.UnaryRPCMessage:output_type -> example.contract.v1.MessageResponse
	3, // 5: example.contract.v1.example.ServerSideStream:output_type -> example.contract.v1.MessageStreamResponse
	1, // 6: example.contract.v1.example.ClientSideStream:output_type -> example.contract.v1.MessageResponse
	3, // 7: example.contract.v1.example.BidirectionalStream:output_type -> example.contract.v1.MessageStreamResponse
