...
func (x *OpenSandboxAccountRequest) Reset() {
	*x = OpenSandboxAccountRequest{}
	mi := &file_t_invest_sandbox_proto_msgTypes[0]
...
func (*OpenSandboxAccountRequest) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{0}
}
...
func (x *OpenSandboxAccountResponse) Reset() {
	*x = OpenSandboxAccountResponse{}
	mi := &file_t_invest_sandbox_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenSandboxAccountResponse) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{1}
}
...
func (x *CloseSandboxAccountRequest) Reset() {
	*x = CloseSandboxAccountRequest{}
	mi := &file_t_invest_sandbox_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloseSandboxAccountRequest) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{2}
}
...
func (x *CloseSandboxAccountResponse) Reset() {
	*x = CloseSandboxAccountResponse{}
	mi := &file_t_invest_sandbox_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloseSandboxAccountResponse) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{3}
}
...
func (x *SandboxPayInRequest) Reset() {
	*x = SandboxPayInRequest{}
	mi := &file_t_invest_sandbox_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SandboxPayInRequest) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{4}
}
...
func (x *SandboxPayInResponse) Reset() {
	*x = SandboxPayInResponse{}
	mi := &file_t_invest_sandbox_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SandboxPayInResponse) Descriptor() ([]byte, []int) {
	return file_t_invest_sandbox_proto_rawDescGZIP(), []int{5}
}
...
var File_t_invest_sandbox_proto protoreflect.FileDescriptor

const file_t_invest_sandbox_proto_rawDesc = "" +
	"\n" +
	"\x16t-invest/sandbox.proto\x12%tinkoff.public.invest.api.contract.v1\x1a\x15t-invest/common.proto\x1a\x15t-invest/orders.proto\x1a\x19t-invest/operations.proto\x1a\x14t-invest/users.proto\x1a\x1fgoogle/api/field_behavior.proto\"=\n" +
	...
	"\x11GetSandboxMaxLots\x128.tinkoff.public.invest.api.contract.v1.GetMaxLotsRequest\x1a9.tinkoff.public.invest.api.contract.v1.GetMaxLotsResponseBz\n" +
...
var (
	file_t_invest_sandbox_proto_rawDescOnce sync.Once
	file_t_invest_sandbox_proto_rawDescData []byte
)

func file_t_invest_sandbox_proto_rawDescGZIP() []byte {
	file_t_invest_sandbox_proto_rawDescOnce.Do(func() {
		file_t_invest_sandbox_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_t_invest_sandbox_proto_rawDesc), len(file_t_invest_sandbox_proto_rawDesc)))
	})
	return file_t_invest_sandbox_proto_rawDescData
}

var file_t_invest_sandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_t_invest_sandbox_proto_goTypes = []any{
...
var file_t_invest_sandbox_proto_depIdxs = []int32{
...
func init() { file_t_invest_sandbox_proto_init() }
func file_t_invest_sandbox_proto_init() {
	if File_t_invest_sandbox_proto != nil {
		return
	}
	file_t_invest_common_proto_init()
	file_t_invest_orders_proto_init()
	file_t_invest_operations_proto_init()
	file_t_invest_users_proto_init()
	file_t_invest_sandbox_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_t_invest_sandbox_proto_rawDesc), len(file_t_invest_sandbox_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_t_invest_sandbox_proto_goTypes,
		DependencyIndexes: file_t_invest_sandbox_proto_depIdxs,
		MessageInfos:      file_t_invest_sandbox_proto_msgTypes,
	}.Build()
	File_t_invest_sandbox_proto = out.File
	file_t_invest_sandbox_proto_goTypes = nil
	file_t_invest_sandbox_proto_depIdxs = nil
}
