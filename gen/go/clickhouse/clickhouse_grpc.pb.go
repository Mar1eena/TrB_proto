...
const file_clickhouse_clickhouse_grpc_proto_rawDesc = "" +
	...
	"\tLOG_DEBUG\x10\a\x12\r\n" +
	"\tLOG_TRACE\x10\b2\xf3\x02\n" +
	"\n" +
	"ClickHouse\x12]\n" +
	"\fExecuteQuery\x12\x1a.clickhouse.grpc.QueryInfo\x1a\x17.clickhouse.grpc.Result\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/ExecuteQuery\x12V\n" +
