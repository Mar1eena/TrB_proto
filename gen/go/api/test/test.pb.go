...
const file_api_test_test_proto_rawDesc = "" +
	...
	"\x06upsert\x18\x01 \x01(\v28.trb.db.api.public.contract.v1.UpsertInstrumentsResponseR\x06upsert2\xc5\x01\n" +
	"\x04Test\x12\xbc\x01\n" +
	"\x12SyncInstrumentsAAA\x123.trb.test.public.contract.v1.SyncInstrumentsRequest\x1a4.trb.test.public.contract.v1.SyncInstrumentsResponse\";\x82\xd3\xe4\x93\x025:\x01*Z\x15:\x01*\"\x10/SyncInstruments\"\x19/v1/test/instruments/syncB4Z2github.com/Mar1eena/trb_proto/gen/go/api/test;testb\x06proto3"
...
var file_api_test_test_proto_depIdxs = []int32{
	...
	0, // 1: trb.test.public.contract.v1.Test.SyncInstrumentsAAA:input_type -> trb.test.public.contract.v1.SyncInstrumentsRequest
	1, // 2: trb.test.public.contract.v1.Test.SyncInstrumentsAAA:output_type -> trb.test.public.contract.v1.SyncInstrumentsResponse
