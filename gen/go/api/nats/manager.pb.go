...
const file_api_nats_manager_proto_rawDesc = "" +
	...
	"\n" +
	"StreamList\x12F\n" +
	"\x05items\x18\x01 \x03(\v20.trb.nats.manager.public.contract.v1.StreamInfosR\x05items\"&\n" +
	"\x0eStreamNameList\x12\x14\n" +
	"\x05names\x18\x01 \x03(\tR\x05names\"X\n" +
	"\fConsumerList\x12H\n" +
	"\x05items\x18\x01 \x03(\v22.trb.nats.manager.public.contract.v1.ConsumerInfosR\x05items\"(\n" +
	...
	"\n" +
	"push_bound\x18\v \x01(\bR\tpushBound\x12K\n" +
	"\x06config\x18\f \x01(\v23.trb.nats.manager.public.contract.v1.ConsumerConfigR\x06config\"\x8d\x01\n" +
	"\fSequenceInfo\x12!\n" +
	...
	"\fUpdateStream\x121.trb.nats.manager.public.contract.v1.StreamConfig\x1a0.trb.nats.manager.public.contract.v1.StreamInfos\"6\x82\xd3\xe4\x93\x020:\x01*Z\x12:\x01*\"\r/UpdateStream\x1a\x17/v1/nats/streams/{name}\x12\xa3\x01\n" +
	"\fDeleteStream\x12/.trb.nats.manager.public.contract.v1.StreamName\x1a-.trb.nats.manager.public.contract.v1.Response\"3\x82\xd3\xe4\x93\x02-Z\x12:\x01*\"\r/DeleteStream*\x17/v1/nats/streams/{name}\x12\xa2\x01\n" +
	"\n" +
	"StreamInfo\x12/.trb.nats.manager.public.contract.v1.StreamName\x1a0.trb.nats.manager.public.contract.v1.StreamInfos\"1\x82\xd3\xe4\x93\x02+Z\x10:\x01*\"\v/StreamInfo\x12\x17/v1/nats/streams/{name}\x12\xa7\x01\n" +
	"\vPurgeStream\x12/.trb.nats.manager.public.contract.v1.StreamName\x1a-.trb.nats.manager.public.contract.v1.Response\"8\x82\xd3\xe4\x93\x022Z\x11:\x01*\"\f/PurgeStream\"\x1d/v1/nats/streams/{name}:purge\x12\x9d\x01\n" +
	...
	"/DeleteMsg*&/v1/nats/streams/{name}/messages/{seq}\x12\xbe\x01\n" +
	"\x0fSecureDeleteMsg\x12(.trb.nats.manager.public.contract.v1.Msg\x1a-.trb.nats.manager.public.contract.v1.Response\"R\x82\xd3\xe4\x93\x02LZ\x15:\x01*\"\x10/SecureDeleteMsg\"3/v1/nats/streams/{name}/messages/{seq}:secureDelete\x12\xb1\x01\n" +
	"\vAddConsumer\x12-.trb.nats.manager.public.contract.v1.Consumer\x1a2.trb.nats.manager.public.contract.v1.ConsumerInfos\"?\x82\xd3\xe4\x93\x029:\x01*Z\x11:\x01*\"\f/AddConsumer\"!/v1/nats/streams/{name}/consumers\x12\xb7\x01\n" +
	"\x0eUpdateConsumer\x12-.trb.nats.manager.public.contract.v1.Consumer\x1a2.trb.nats.manager.public.contract.v1.ConsumerInfos\"B\x82\xd3\xe4\x93\x02<:\x01*Z\x14:\x01*\"\x0f/UpdateConsumer\x1a!/v1/nats/streams/{name}/consumers\x12\xbc\x01\n" +
	"\x0eDeleteConsumer\x121.trb.nats.manager.public.contract.v1.ConsumerName\x1a-.trb.nats.manager.public.contract.v1.Response\"H\x82\xd3\xe4\x93\x02BZ\x14:\x01*\"\x0f/DeleteConsumer**/v1/nats/streams/{stream}/consumers/{name}\x12\xbd\x01\n" +
	"\fConsumerInfo\x121.trb.nats.manager.public.contract.v1.ConsumerName\x1a2.trb.nats.manager.public.contract.v1.ConsumerInfos\"F\x82\xd3\xe4\x93\x02@Z\x12:\x01*\"\r/ConsumerInfo\x12*/v1/nats/streams/{stream}/consumers/{name}\x12\xb8\x01\n" +
	"\rConsumersInfo\x12/.trb.nats.manager.public.contract.v1.StreamName\x1a1.trb.nats.manager.public.contract.v1.ConsumerList\"C\x82\xd3\xe4\x93\x02=Z\x13:\x01*\"\x0e/ConsumersInfo\x12&/v1/nats/streams/{name}/consumers:info\x12\xab\x01\n" +
	"\tConsumers\x12/.trb.nats.manager.public.contract.v1.StreamName\x1a1.trb.nats.manager.public.contract.v1.ConsumerList\":\x82\xd3\xe4\x93\x024Z\x0f:\x01*\"\n" +
	"/Consumers\x12!/v1/nats/streams/{name}/consumers\x12\xbc\x01\n" +
...
var file_api_nats_manager_proto_goTypes = []any{
	...
	(*SubjectQuery)(nil),                // 3: trb.nats.manager.public.contract.v1.SubjectQuery
	(*StreamList)(nil),                  // 4: trb.nats.manager.public.contract.v1.StreamList
	(*StreamNameList)(nil),              // 5: trb.nats.manager.public.contract.v1.StreamNameList
	(*ConsumerList)(nil),                // 6: trb.nats.manager.public.contract.v1.ConsumerList
	(*ConsumerNameList)(nil),            // 7: trb.nats.manager.public.contract.v1.ConsumerNameList
	(*Response)(nil),                    // 8: trb.nats.manager.public.contract.v1.Response
	(*StreamName)(nil),                  // 9: trb.nats.manager.public.contract.v1.StreamName
	(*StreamConfig)(nil),                // 10: trb.nats.manager.public.contract.v1.StreamConfig
	(*Placement)(nil),                   // 11: trb.nats.manager.public.contract.v1.Placement
	(*StreamSource)(nil),                // 12: trb.nats.manager.public.contract.v1.StreamSource
	(*ExternalStream)(nil),              // 13: trb.nats.manager.public.contract.v1.ExternalStream
	(*SubjectTransformConfig)(nil),      // 14: trb.nats.manager.public.contract.v1.SubjectTransformConfig
	(*RePublish)(nil),                   // 15: trb.nats.manager.public.contract.v1.RePublish
	(*StreamConsumerLimits)(nil),        // 16: trb.nats.manager.public.contract.v1.StreamConsumerLimits
	(*StreamInfos)(nil),                 // 17: trb.nats.manager.public.contract.v1.StreamInfos
	(*StreamSourceInfo)(nil),            // 18: trb.nats.manager.public.contract.v1.StreamSourceInfo
	(*StreamAlternate)(nil),             // 19: trb.nats.manager.public.contract.v1.StreamAlternate
	(*APIError)(nil),                    // 20: trb.nats.manager.public.contract.v1.APIError
	(*ClusterInfo)(nil),                 // 21: trb.nats.manager.public.contract.v1.ClusterInfo
	(*PeerInfo)(nil),                    // 22: trb.nats.manager.public.contract.v1.PeerInfo
...
var file_api_nats_manager_proto_depIdxs = []int32{
	...
	18, // 17: trb.nats.manager.public.contract.v1.StreamInfos.sources:type_name -> trb.nats.manager.public.contract.v1.StreamSourceInfo
	19, // 18: trb.nats.manager.public.contract.v1.StreamInfos.alternates:type_name -> trb.nats.manager.public.contract.v1.StreamAlternate
	13, // 19: trb.nats.manager.public.contract.v1.StreamSourceInfo.external:type_name -> trb.nats.manager.public.contract.v1.ExternalStream
