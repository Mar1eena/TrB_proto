...
export class StrategySpec extends jspb.Message {
  getVersion(): number;
  setVersion(value: number): StrategySpec;

  getIndicatorsList(): Array<IndicatorRef>;
  setIndicatorsList(value: Array<IndicatorRef>): StrategySpec;
  clearIndicatorsList(): StrategySpec;
  addIndicators(value?: IndicatorRef, index?: number): IndicatorRef;

  getEntryLong(): BoolExpr | undefined;
  setEntryLong(value?: BoolExpr): StrategySpec;
  hasEntryLong(): boolean;
  clearEntryLong(): StrategySpec;

  getExitLong(): BoolExpr | undefined;
  setExitLong(value?: BoolExpr): StrategySpec;
  hasExitLong(): boolean;
  clearExitLong(): StrategySpec;

  getEntryShort(): BoolExpr | undefined;
  setEntryShort(value?: BoolExpr): StrategySpec;
  hasEntryShort(): boolean;
  clearEntryShort(): StrategySpec;

  getExitShort(): BoolExpr | undefined;
  setExitShort(value?: BoolExpr): StrategySpec;
  hasExitShort(): boolean;
  clearExitShort(): StrategySpec;

  getSizing(): PositionSizing | undefined;
  setSizing(value?: PositionSizing): StrategySpec;
  hasSizing(): boolean;
  clearSizing(): StrategySpec;

  getRisk(): RiskControls | undefined;
  setRisk(value?: RiskControls): StrategySpec;
  hasRisk(): boolean;
  clearRisk(): StrategySpec;

  getWarmupBars(): number;
  setWarmupBars(value: number): StrategySpec;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StrategySpec.AsObject;
  static toObject(includeInstance: boolean, msg: StrategySpec): StrategySpec.AsObject;
  static serializeBinaryToWriter(message: StrategySpec, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StrategySpec;
  static deserializeBinaryFromReader(message: StrategySpec, reader: jspb.BinaryReader): StrategySpec;
}

export namespace StrategySpec {
  export type AsObject = {
    version: number,
