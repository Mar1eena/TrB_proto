...
proto.tinkoff.public.invest.api.contract.v1.TradesStreamResponse.prototype.getPing = function() {
  return /** @type{?proto.tinkoff.public.invest.api.contract.v1.Ping} */ (
    jspb.Message.getWrapperField(this, api_tinvest_common_pb.Ping, 2));
};
...
initialOrderPrice: (f = msg.getInitialOrderPrice()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
executedOrderPrice: (f = msg.getExecutedOrderPrice()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
totalOrderAmount: (f = msg.getTotalOrderAmount()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
initialCommission: (f = msg.getInitialCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
executedCommission: (f = msg.getExecutedCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
...
initialSecurityPrice: (f = msg.getInitialSecurityPrice()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
orderType: jspb.Message.getFieldWithDefault(msg, 14, 0),
message: jspb.Message.getFieldWithDefault(msg, 15, ""),
initialOrderPricePt: (f = msg.getInitialOrderPricePt()) && api_tinvest_common_pb.Quotation.toObject(includeInstance, f),
...
serviceCommission: (f = msg.getServiceCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
...
proto.tinkoff.public.invest.api.contract.v1.GetMaxLotsResponse.BuyLimitsView.toObject = function(includeInstance, msg) {
  var f, obj = {
buyMoneyAmount: (f = msg.getBuyMoneyAmount()) && api_tinvest_common_pb.Quotation.toObject(includeInstance, f),
...
proto.tinkoff.public.invest.api.contract.v1.GetOrderPriceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
totalOrderAmount: (f = msg.getTotalOrderAmount()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
initialOrderAmount: (f = msg.getInitialOrderAmount()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
lotsRequested: jspb.Message.getFieldWithDefault(msg, 3, 0),
executedCommission: (f = msg.getExecutedCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
executedCommissionRub: (f = msg.getExecutedCommissionRub()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
serviceCommission: (f = msg.getServiceCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
dealCommission: (f = msg.getDealCommission()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
...
proto.tinkoff.public.invest.api.contract.v1.GetOrderPriceResponse.ExtraBond.toObject = function(includeInstance, msg) {
  var f, obj = {
aciValue: (f = msg.getAciValue()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
nominalConversionRate: (f = msg.getNominalConversionRate()) && api_tinvest_common_pb.Quotation.toObject(includeInstance, f)
  };
...
proto.tinkoff.public.invest.api.contract.v1.GetOrderPriceResponse.ExtraFuture.toObject = function(includeInstance, msg) {
  var f, obj = {
initialMargin: (f = msg.getInitialMargin()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f)
  };
...
error: (f = msg.getError()) && api_tinvest_common_pb.ErrorDetail.toObject(includeInstance, f)
  };
...
proto.tinkoff.public.invest.api.contract.v1.SubscriptionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 7:
      var value = new api_tinvest_common_pb.ErrorDetail;
      reader.readMessage(value,api_tinvest_common_pb.ErrorDetail.deserializeBinaryFromReader);
      msg.setError(value);
      break;
    default:
      reader.skipField();
...
proto.tinkoff.public.invest.api.contract.v1.SubscriptionResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      api_tinvest_common_pb.ErrorDetail.serializeBinaryToWriter
    );
  }
};
...
proto.tinkoff.public.invest.api.contract.v1.SubscriptionResponse.prototype.getError = function() {
  return /** @type{?proto.tinkoff.public.invest.api.contract.v1.ErrorDetail} */ (
    jspb.Message.getWrapperField(this, api_tinvest_common_pb.ErrorDetail, 7));
};
...
initialOrderPrice: (f = msg.getInitialOrderPrice()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
orderPrice: (f = msg.getOrderPrice()) && api_tinvest_common_pb.MoneyValue.toObject(includeInstance, f),
...
proto.tinkoff.public.invest.api.contract.v1.OrderStateStreamResponse.OrderState.prototype.getInitialOrderPrice = function() {
  return /** @type{?proto.tinkoff.public.invest.api.contract.v1.MoneyValue} */ (
    jspb.Message.getWrapperField(this, api_tinvest_common_pb.MoneyValue, 22));
};
...
proto.tinkoff.public.invest.api.contract.v1.OrderStateStreamResponse.OrderState.prototype.getExecutedOrderPrice = function() {
  return /** @type{?proto.tinkoff.public.invest.api.contract.v1.MoneyValue} */ (
    jspb.Message.getWrapperField(this, api_tinvest_common_pb.MoneyValue, 25));
};
