...
export class TestClient {
  ...
  methodDescriptorSyncInstrumentsAAA = new grpcWeb.MethodDescriptor(
    '/trb.test.public.contract.v1.Test/SyncInstrumentsAAA',
  ...
  syncInstrumentsAAA(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorSyncInstrumentsAAA,
        callback);
    }
